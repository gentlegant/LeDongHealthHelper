...
public abstract class BaseSqlTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> {
    private String url = "jdbc:mysql://192.168.31.174:3306/ledong_health_helper_db?useSSL=false&allowPublicKeyRetrieval=true&useUnicode=true&characterEncoding=utf-8";
